...
- **Camouflage:** Fur shimmers to match surroundings. Ranged attacks against a weren at a distance receive a **+1 step penalty**, and the weren receives a **-1 step bonus** to [Covert Ops-stealth](/skills/covert-ops/stealth) checks. This ability does not function if the weren is wearing clothing or armor that covers more than 15% of their body.
