...
### Progresión de Rango
▶ **Rango 3 [Beneficio de Acción]:** Esquivar y realizar una acción en la misma fase (+2 de penalización en la acción), esto solo consume 1 de las acciones del personaje.
⊗ **Rango 4, 8, 12 [Modificador de Resistencia]:** El modificador de resistencia de Destreza del personaje mejora en **+1** en cada uno de estos rangos.
▶ **Rango 7 [Esquiva de Reacción]:** Realizar una esquiva de reacción, permitiendo al personaje defenderse antes en el asalto. En un asalto en el que un personaje realiza una esquiva de reacción, solo puede esquivar; todas las demás acciones se pierden para el asalto.
...
### Resultados
- **Fallo Crítico:** La acción falla y el personaje podría sufrir daño de aturdimiento o herida (fallo del equipo).
- **Fallo:** La acción no tiene éxito, pero el personaje no necesariamente sufre daño (p. ej., aterrizar fuera de curso).
- **Ordinario:** El personaje realiza la acción pero con un control mínimo.
- **Bueno:** El personaje tiene un control limitado y ejecuta la acción bien.
- **Asombroso:** Todo sale bien; la acción se ejecuta perfectamente sin daño.

---

## Entrenamiento en Gravedad Cero (DEX - Solo Entrenados)
...
### Progresión de Rango
⊗ **Rango 4:** La penalización en gravedad cero se reduce a **+1 paso**, y las acciones en gravedad ligera reciben un **bono de -1 paso**.
⊗ **Rango 7:** Se elimina la penalización en gravedad cero.
⊗ **Rango 10:** Las acciones físicas en gravedad cero reciben un **bono de -1 paso**. (El bono de gravedad ligera nunca mejora más allá de -1 paso).

**Ventaja Sesheyan:** Los personajes Sesheyan sin la habilidad de entrenamiento en gravedad cero funcionan como si la tuvieran en rango 1. Si un Sesheyan compra esta habilidad, las penalizaciones se reducen en 1 paso y los bonos mejoran en la misma cantidad (bono máximo -2 en gravedad ligera).
...
### Resultados
- **Fallo Crítico:** Pérdida de control, posible pérdida de sustentación o colisión.
...
- **Asombroso:** Control perfecto; puede realizar acrobacias aéreas u orbitales complejas.
