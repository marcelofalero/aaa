...
Las comprobaciones de habilidad realizadas para determinar si un personaje conoce una cierta pieza de información técnica, o si es capaz de investigar una pregunta y descubrir una respuesta, se realizan de la misma manera que las comprobaciones de la habilidad **Conocimiento**.
...
- **Éxito Ordinario:** El sistema u objeto entra en funcionamiento durante **d6+1 unidades de tiempo**, y se necesitan **3 éxitos más** para las reparaciones completas (además de los que ya se requerían).
