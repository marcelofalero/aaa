...
⊗ **Juryrig mejorado:** Cuando un Personaje alcanza **Rango 6**, su habilidad mejora de la siguiente manera: un éxito de Ordinario produce un resultado de Bueno, un éxito de Bueno produce un resultado de Asombroso y un éxito de Asombroso significa que el jurado funciona tan bien que el sistema o elemento se considera reparado y en buenas condiciones de funcionamiento.
