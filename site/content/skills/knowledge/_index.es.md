...
Esta habilidad amplia representa la capacidad de un personaje para saber al menos un poco sobre cualquier tema en particular. Solo CON la habilidad amplia, un personaje no es considerado un experto, pero representa la capacidad de recordar lógicamente una clase que tomó, un artículo que leyó o un documental que vio sobre el tema en cuestión. Las comprobaciones de la habilidad de Conocimiento generalmente se realizan en secreto para que los jugadores ni siquiera sepan que se está realizando la comprobación. Una vez que se determina que un personaje tiene conocimiento sobre un tema en particular, se puede hacer una nota en la hoja del personaje.
### Tabla P24: Categorías de Conocimiento
Para una comprobación de la habilidad de Conocimiento, el Director de Juego determina a qué categoría pertenece la información buscada: | Categoría | Modificador | Complejidad | | :--- | :--- | :--- | | **Trivial** | +1 paso | Marginal | | **General** | Ninguno | Ordinaria | | **Específica** | +2 pasos | Buena | | **Experta** | +3 pasos | Asombrosa |
- **Trivial:** Información simple, obvia o fácilmente disponible.
- **General:** Características clave de un tema, no detalles ni pormenores.
- **Específica:** Características especiales de un tema, detalles conocidos por alguien íntimamente relacionado CON el tema.
- **Experta:** Un nivel de detalle que generalmente solo se adquiere a través de la experiencia, la investigación o el entrenamiento.
...
La habilidad de primeros auxilios se puede usar para curar heridas, aunque se requiere un kit de primeros auxilios o un paquete de traumatología.
- **Kit de Primeros Auxilios:** Se requiere una comprobación de habilidad compleja de **Complejidad Buena** (1 herida curada al finalizar).
...
La especialidad de investigación cubre las técnicas utilizadas para encontrar, verificar y organizar información de diversas fuentes, incluidos archivos físicos, bancos de datos electrónicos y la Red. También se utiliza para representar la capacidad de un personaje para aprender y mejorar habilidades a través del estudio y la mentoría.
### Mentoría y Aprendizaje
Un personaje puede utilizar la investigación para asistir a otro personaje (o a sí mismo) en el aprendizaje de una nueva habilidad o en la mejora de una existente. Una comprobación de investigación exitosa proporciona una bonificación al tiempo de aprendizaje requerido:
...
⊗ **Investigación Eficiente:** A medida que un personaje alcanza rangos más altos en esta especialidad, se vuelve más eficiente al indagar en los datos. Recibe una **bonificación de -1 paso** en las tiradas de investigación en el **rango 3**, **-2 en el rango 6**, **-3 en el rango 9** y **-4 en el rango 12**.
