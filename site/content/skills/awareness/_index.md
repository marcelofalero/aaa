...
The Gamemaster will call for a check when a psionic power is activated in the character's vicinity, similar to a check to detect an ambush.
...
If the character attempts a **Knowledge - Psionics** check to identify or trace the source of the specific power or phenomenon detected, they receive a bonus based on their Psionic Sense result:
...
Characters capable of using the **Clairvoyance** power can use it to trace the source of the psionic event, applying the same bonus to their Clairvoyance skill check (0, -1, or -3 steps).
