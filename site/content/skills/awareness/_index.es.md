...
**Solo Entrenado.** Solo los personajes capaces de usar poderes psiónicos (como los Caminantes Mentales) o aquellos que tienen la ventaja "Conciencia Psiónica" pueden comprar y usar esta habilidad. Esta habilidad de especialidad permite a un personaje detectar la activación de poderes psiónicos, así como la presencia de fenómenos psiónicos. Se puede utilizar para ayudar a identificar el tipo general de poder psiónico que se está utilizando, la dirección de su fuente y la intensidad aproximada del usuario psiónico.
