+++
title = "Rules of Play"
description = "Core mechanics and system rules for the Alternity game."
weight = 15
+++
...
- **Success Check:** Roll `d20` +/- `Situation Die`. Compare to the relevant score (Ability or Skill).
- **Lower is Better:** You aim to roll as low as possible.
