+++
title = "Skills"
description = "How to do things right"
weight = 4
+++
...
Every character receives six free broad skills at the beginning of his career, based on species and backgroud.
...
As the character pursues her career, she receives experience points from the Gamemaster as rewards for successful completion of missions and attainment of goals. The character is entitled to spend this points to impreve his skill, usually between sessions. If the Gamemaster consider it appropriate he can allow the character to improve a skill mid-session, normally representing some sort of insight. For specific details refer to the [Character Advancement](/core-mechanics/character-advancement) Section.
...
Modifiers to the situation die generally range from an Extreme penalty (+3 steps) to an Amazing bonus (-3 steps), as shown on the table above. Many of the skill descriptions in this chapter provide examples of various situation die modifiers that players and the Gamemaster can use to help them determine how easy or difficult it is to succeed at a skill check under various conditions.
...
| Amazing | 8 to 10* |
  ...
  <p class="tc f6 i mb0 mt3" style="color: var(--table-text-light);">*Specific number decided by the Gamemaster.</p>
</div>
...
In almost every case, only the acting character makes a skill check to determine the result of his attempt to do something. But sometimes the outcome of a situation may depend on what happens when characters compete with one another. The Gamemaster Guide has more details on this, but in general here's how it works:
