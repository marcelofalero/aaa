+++
title = "Telequinesia (Telekinesis)"
description = "Manipula el entorno físico sólo con el poder de la mente."
weight = 3
attribute = "WIL"
category = "Psionics"
untrained = true
...
Esta habilidad amplia permite a un héroe manipular su entorno físico con el poder de su mente.
...
- **[Escudo Kinético](kinetic-shield)**: Crear un escudo defensivo invisible contra ataques físicos y de energía.
- **[Levitación](levitation)**: Elevarse por el aire y propulsarse mediante el vuelo.
- **[Fotoquinesis](photokinetics)**: Manipular las moléculas de luz para iluminar zonas o crear ilusiones.
