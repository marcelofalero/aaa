...
*   [Obsesionado](/perks_flaws/#obsessed) (Con descubrir la verdad absoluta de una situación, independientemente del peligro que represente para ti o tus aliados).

## Equipo Inicial:
Un equipo de micrograbación de alta gama, un pase de prensa oficial (o falsificado de alta precisión), un comunicador desechable y un depurador de datos portátil.
