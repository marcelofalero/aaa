...
TABLE P27: FLAWS lists the flaws, the bonus skill points they provide, and the ability each is associated with. Unlike perks, all flaws provide a hero with a constant penalty of some sort. Flaws can be removed when a hero attains achievement level 6; see Chapter 8: Achievements for details.
